...
class RemoveModerator extends Component {
  constructor(props) {
    super(props)
        ...
        <div>
          ...
          <Grid item xs={12} >
            ...
            <Grid item xs={12}>
              ...
              <Grid item xs={12}>
                <Button raised type="submit" color="primary">Update Moderator</Button>
...
export default withStyles(styles)(RemoveModerator);
