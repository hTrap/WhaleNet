...
import WhaleNetwork from '../../../build/contracts/WhaleNetworkV2.json'
import WhaleRewards from '../../../build/contracts/WhaleRewardsV2.json'
...
export default withStyles(styles)(AppV3);
